    ...
    public class NewsController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            foreach (var item in result)
            {
                ...
                MarkNews.Add(NewsDAO.Instance.GetNewsMarkByUserID((Session[CommonConstaints.MANAGER_USER_SESSION] as UserLogin).UserID, item.MaNew));
        ...
        {
            int id = (Session[CommonConstaints.MANAGER_USER_SESSION] as UserLogin).UserID;
        ...
        public ActionResult ManagerComment(int id)
        {
            ...
            foreach (var item in ListRootComment)
            {
                ...
                MarkComment.Add(NewsDAO.Instance.GetRootCommentMarkByUserID((Session[CommonConstaints.MANAGER_USER_SESSION] as UserLogin).UserID, item.ID));
        ...
        {
            //id->RootID
            bool status = NewsDAO.Instance.LikeRootByUserIDAndRootID(id, (Session[CommonConstaints.MANAGER_USER_SESSION] as UserLogin).UserID);
            return Json(new
            {
                status = status
            });
        ...
        {
            //id->NewsID
            bool status = NewsDAO.Instance.LikeNewsByUserIDAndNewsID(id, (Session[CommonConstaints.MANAGER_USER_SESSION] as UserLogin).UserID);
            return Json(new
            {
                status = status,
