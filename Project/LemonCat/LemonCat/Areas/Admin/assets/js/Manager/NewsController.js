var RootComment_News = {
    ...
    resisterEvent: function () {
        $('.triggerRootComment_News').off('click').on('click', function (e) {
            ...
            var id = btn.data('id');
            $.ajax({
                url: "/Manager/News/ChangeStatusRoot",
                data: { id: id },
                dataType: "Json",
                type: "POST",
...
var ChildComment_News = {
    ...
    resisterEvent: function () {
        $('.triggerChildComment_News').off('click').on('click', function (e) {
            ...
            var id = btn.data('id');
            $.ajax({
                url: "/Manager/News/ChangeStatusChild",
                data: { id: id },
                dataType: "Json",
                type: "POST",
...
var NewsStatus = {
    ...
    resisterEvent: function () {
        $('.triggerNewsStatus').off('click').on('click', function (e) {
            ...
            var id = btn.data('id');
            $.ajax({
                url: "/Manager/News/ChangeStatusNews",
                data: { id: id },
                dataType: "Json",
                type: "POST",
